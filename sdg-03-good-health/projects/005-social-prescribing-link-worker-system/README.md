# Social Prescribing Link Worker System
...
NHS platform connecting patients with community support services
...
```
005-social-prescribing-link-worker-system/
├── README.md (this file)
│
├── # Core Documents
├── ARC-005-STKE-v1.0.md     # Stakeholder drivers (/arckit.stakeholders)
├── ARC-005-RISK-v1.0.md     # Risk register (/arckit.risk)
├── ARC-005-SOBC-v1.0.md     # Business case (/arckit.sobc)
├── ARC-005-REQ-v1.0.md      # Requirements (/arckit.requirements)
├── ARC-005-DATA-v1.0.md     # Data model (/arckit.data-model)
├── ARC-005-RSCH-v1.0.md     # Research findings (/arckit.research)
├── ARC-005-TRAC-v1.0.md     # Traceability matrix (/arckit.traceability)
│
├── # Procurement
├── ARC-005-SOW-v1.0.md      # Statement of Work (/arckit.sow)
├── ARC-005-EVAL-v1.0.md     # Evaluation criteria (/arckit.evaluate)
│
├── # Multi-instance Documents (subdirectories)
├── decisions/
│   ├── ARC-005-ADR-001-v1.0.md  # Architecture decisions (/arckit.adr)
│   └── ARC-005-ADR-002-v1.0.md
├── diagrams/
│   └── ARC-005-DIAG-001-v1.0.md # Diagrams (/arckit.diagram)
├── wardley-maps/
│   └── ARC-005-WARD-001-v1.0.md # Wardley maps (/arckit.wardley)
├── reviews/
│   ├── ARC-005-HLD-v1.0.md      # HLD review (/arckit.hld-review)
│   └── ARC-005-DLD-v1.0.md      # DLD review (/arckit.dld-review)
│
