# Disability Confident Employer Portal
...
DWP platform for disability-inclusive employment certification
...
```
004-disability-confident-employer-portal/
├── README.md (this file)
│
├── # Core Documents
├── ARC-004-STKE-v1.0.md     # Stakeholder drivers (/arckit.stakeholders)
├── ARC-004-RISK-v1.0.md     # Risk register (/arckit.risk)
├── ARC-004-SOBC-v1.0.md     # Business case (/arckit.sobc)
├── ARC-004-REQ-v1.0.md      # Requirements (/arckit.requirements)
├── ARC-004-DATA-v1.0.md     # Data model (/arckit.data-model)
├── ARC-004-RSCH-v1.0.md     # Research findings (/arckit.research)
├── ARC-004-TRAC-v1.0.md     # Traceability matrix (/arckit.traceability)
│
├── # Procurement
├── ARC-004-SOW-v1.0.md      # Statement of Work (/arckit.sow)
├── ARC-004-EVAL-v1.0.md     # Evaluation criteria (/arckit.evaluate)
│
├── # Multi-instance Documents (subdirectories)
├── decisions/
│   ├── ARC-004-ADR-001-v1.0.md  # Architecture decisions (/arckit.adr)
│   └── ARC-004-ADR-002-v1.0.md
├── diagrams/
│   └── ARC-004-DIAG-001-v1.0.md # Diagrams (/arckit.diagram)
├── wardley-maps/
│   └── ARC-004-WARD-001-v1.0.md # Wardley maps (/arckit.wardley)
├── reviews/
│   ├── ARC-004-HLD-v1.0.md      # HLD review (/arckit.hld-review)
│   └── ARC-004-DLD-v1.0.md      # DLD review (/arckit.dld-review)
│
